...
SELECT
	...
	CASE
		...
		or length > 210 THEN 'Great rating or very long (tier 1)'
		WHEN description ILIKE '%Drama%'
		and length > 90 THEN 'Long drama (tier 2)'
		WHEN description ILIKE '%Drama%'
		and length <= 90 THEN 'Short drama (tier 3)'
