...
WHERE
    payment_id BETWEEN 17000 AND 18000;
...
FROM
    rental
WHERE
    rental_date BETWEEN '2005-08-01' AND '2005-08-02'
ORDER BY
    rental_date DESC;
...
FROM
    rental
WHERE
    rental_date BETWEEN '2005-08-01' AND '2005-08-02 23:59'
ORDER BY
    rental_date DESC;
...
FROM
    customer
WHERE
    customer_id IN (123, 212, 323, 243, 353, 432);
