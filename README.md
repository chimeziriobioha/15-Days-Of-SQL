### So, I took a look at the language behind the ORM abstractions I've been using to work with databases all the while. That is, the beautiful and very important `Structured Query Language - SQL`.
