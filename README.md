### So, I decided to take a look at the language behind the ORM abstractions I've been using to work with databases all the while. The beautiful `Structured Query Language - SQL`.
